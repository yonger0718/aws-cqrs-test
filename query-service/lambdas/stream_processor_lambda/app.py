            ...
            if event_name in ['INSERT', 'MODIFY']:
                ...
                if new_image:
                    ...
                    try:
                        ...
                        processed_records += 1
                        logger.info(f"Successfully wrote record to query table: {query_record['transaction_id']}")
                ...
                if old_image:
                    ...
                    if transaction_id and user_id and created_at:
                        try:
                            ...
                            processed_records += 1
                            logger.info(f"Successfully deleted record from query table: {transaction_id}")
                        except Exception as e:
